                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-7xl mx-auto">
                                  <div className="text-center mb-12">
                                              <h2 className="text-sm font-semibold text-indigo-500 uppercase tracking-wider mb-3">Technical Skills</h2>h2>
                                              <h3 className="text-3xl font-bold text-white">Tools & Technologies</h3>h3>
                                  </div>div>
                            ...
                            <div
                                            ...
                                            <h4 className="font-semibold text-white mb-3 text-lg">{category.title}</h4>h4>
                                  ...
                                  <div>
                                              <div className="flex items-center justify-center gap-3 mb-6">
                                                            ...
                                                            <h3 className="text-2xl font-bold text-white">Certifications</h3>h3>
                                              </div>div>
                              ...
                              <a
                                                ...
                                                <div className="flex flex-col">
                                                                    <span className={`font-semibold text-sm ${cert.textColor}`}>{cert.name}</span>span>
                                                                    <span className="text-xs text-slate-400 mt-0.5">Issued {cert.issued} · AWS</span>span>
                                                </div>div>
