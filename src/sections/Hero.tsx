                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                                  <div className="text-left md:text-left hero-content">
                                              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-6">
                                                            ...
                                                            <span className="text-sm text-indigo-300">Open to opportunities</span>span>
                                              </div>div>
                                              <p className="text-lg font-medium text-indigo-300 mb-2 tracking-wide uppercase">Hi, I'm</p>p>
                                              ...
                                              <div className="flex flex-wrap gap-4 mb-6">
                                                            <a
                                                                                ...
                                                                                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white font-medium transition-all duration-200 shadow-lg shadow-indigo-500/20"
                                                                              >
