            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center hero-content">
                    ...
                    <p className="text-xl text-slate-400 mb-8 max-w-2xl mx-auto leading-relaxed">
                        6 years of experience building scalable ETL pipelines, cloud data warehouses, and Gen AI solutions across financial services and insurance. Specialized in AWS, PySpark, and data lakehouse architectures.
                    </p>
                    ...
                    <div className="flex justify-center gap-8 mb-12">
                        ...
                        <div className="text-center">
                            ...
                            <div className="text-sm text-slate-500">AWS Certs</div>
                        </div>
                        <div className="w-px h-12 bg-slate-800" />
                        <div className="text-center">
                            <div className="text-3xl font-bold text-white">2TB+</div>
                            <div className="text-sm text-slate-500">Daily Data</div>
                        </div>
                    </div>
