      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center projects-content">
          ...
          <p className="text-slate-400 text-lg mb-8">
            ...
            including RAG implementations, data pipelines, and Gen AI experiments.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="https://github.com/DeviMadhuri?tab=repositories"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div className="mt-12 p-6 rounded-2xl bg-slate-900/50 border border-slate-800">
            <p className="text-slate-400 text-sm">
              <span className="text-indigo-400 font-semibold">Currently learning:</span> RAG systems,
              Vector databases, LangChain, and real-time data streaming with Kafka
            </p>
          </div>
